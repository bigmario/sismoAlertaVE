...
*   **Priorización de Menores Solos (Extraviados/No Acompañados):** Implementamos un protocolo de marcado inmediato (`es_menor_no_acompanado`) con índice compuesto optimizado en base de datos. Esto genera alertas visuales de prioridad, filtros rápidos en el buscador para acelerar la reunificación familiar, y una tarjeta de seguimiento crítico en el dashboard principal.
